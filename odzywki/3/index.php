...
$wynik = mysql_query("SELECT p.*,d.waga_porcji,d.ile_razy_dn,z.nazwa_zdjecia FROM produkt p join dawkowanie d on d.ID=p.dawkowanie_ID join zdjecia z on z.ID_produktu=p.ID where p.ID=3") or die('B³¹d zapytania');
